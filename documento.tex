%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Customizacoes do abnTeX2 (http://abnTeX2.googlecode.com)           %%
...
\titulo{Estudo Comparativo de Ferramentas de Shaders e formas de Otimização em diferentes Game Engines}
\data{2021}
...
\begin{document}
	...
	\imprimirfichacatalografica{elementos-pre-textuais/ficha.pdf}
	...
	\imprimirapendices
		...
		\input{elementos-pos-textuais/apendices/coordenadas-homogeneas.tex}
		\input{elementos-pos-textuais/apendices/codigo-fonte-contorno-hlsl}
	\imprimiranexos
		% Adicione aqui os anexos do seu trabalho
		\input{elementos-pos-textuais/anexos/codigo-fonte-outline-glsl}
		\input{elementos-pos-textuais/anexos/codigo-fonte-shader-musgo-unity.tex}
		\input{elementos-pos-textuais/anexos/codigo-fonte-shader-agua-unity.tex}
		%\input{elementos-pos-textuais/anexos/codigo-fonte-shader-agua-godot.tex}
	\imprimirindice
