...
\begin{quadro}[h!]	
	\centering
	\Caption{\label{qua:engines} Componentes que compões as game engines}\UNIFORqua{}{
...
É uma engine, em comparação com a Unity, mais difícil de dominar apesar de possui uma interface amigável, porém com excesso de opções à primeira vista. Seu sistema de programação com \textit{BluePrints} traz uma vantagem para pessoas que não sabem ou não gostam de escrever código \cite{compStudyGE}.
...
\begin{figure}[h!]
	...
	\UNIFORfig{}{
		\fbox{\includegraphics[width=15cm]{figuras/materialUnreal}}
	}{
