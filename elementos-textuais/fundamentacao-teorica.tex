...
\end{lstlisting}
	...
	\begin{figure}[htp]
		\centering
		\Caption{\label{fig:outline} O código-fonte \ref{cf:outline} produz o seguinte efeito ao renderizar.}	
		\UNIFORfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/outline.png}}
		}{
